process DRAGEN_MULTIALIGN {
    ...
    def alignment_params = [
        ...
        (!params.umi && !params.illumina_conversion) && adapter1 && adapter2           ? "--read-trimmers adapter --trim-adapter-read1 ${adapter1} --trim-adapter-read2 ${adapter2}" : "",
        annotation_gtf                                ? "-a ${annotation_gtf}"                                                : "",
        params.umi                                    ? "--umi-enable true --umi-library-type=${params.umi}"                  : "",
        (params.umi || params.illumina_conversion) && params.readfamilysize           ? "--umi-min-supporting-reads ${params.readfamilysize}"                 : "",
        (params.umi || params.illumina_conversion) && target_bed                      ? "--umi-metrics-interval-file ${target_bed}"                           : "",
        (params.umi || params.illumina_conversion) && params.liquid_tumor             ? "--vc-enable-umi-liquid true"                                         : "",
        (params.umi || params.illumina_conversion) && params.solid_tumor              ? "--vc-enable-umi-solid true"                                          : "",
