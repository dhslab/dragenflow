...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Prepare fastq_list file from a passed list file, Dragen demux directory, or reads"
    )
    ...
    if args.read1 and args.read2:
        ...
        if (
            runinfo["Lane"] != runinfo2["Lane"]
            or runinfo["Flowcell"] != runinfo2["Flowcell"]
            or runinfo["Index1"] != runinfo2["Index1"]
        ):
